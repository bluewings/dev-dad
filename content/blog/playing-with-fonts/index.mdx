...
<WarpText message='아빠는 개발자' animate={true} />
...
<WarpText message='아빠는 개발자' outline={true} transform={null} padding={10}
paddingTop={2}
paddingBottom={2}
/>
...
<WarpText message='아빠는 개발자' animate={false} outline={true}
/>
...
transform 함수를 변경하면 다양한 효과를 만들어 보았다.
